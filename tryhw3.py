...
def spherical_panorama():
    ...
    im1 = spherical_project(im1, 1200)
    im2 = spherical_project(im2, 1200)
    im3 = spherical_project(im3, 1200)
    im4 = spherical_project(im4, 1200)
    im5 = spherical_project(im5, 1200)
    im6 = spherical_project(im6, 1200)
    im7 = spherical_project(im7, 1200)
    im8 = spherical_project(im8, 1200)
    save_image(im1, "output/spherical_projection")
